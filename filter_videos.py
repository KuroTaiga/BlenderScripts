...
source_directory = "../MP4s/MultiCameras/Jan13"
destination_directory = "../MP4s/MultiCameras/Z200_Videos"
...
for activity_name in os.listdir(source_directory):
    ...
    if os.path.isdir(activity_path):
        for file_name in os.listdir(activity_path):
            ...
            if file_name.startswith(f"video_{base_name}") and "_Z200_" in file_name:
...
print(f"All videos with Z=200 have been moved to {destination_directory}.")
